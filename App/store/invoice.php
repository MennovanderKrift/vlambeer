...
$company = "Vlambeer";
$address = "Neude 5";
$zipcode = "3512 AD, Utrecht";
$email = "info@vlambeer.com";
...
$vat = "21%";
$bank = "Rabobank";
$iban = "NL 04 RABO 0197608098";
$paypal = "info@vlambeer.com";
$com = $_POST["com"];
$pay = 'Payment information';
$btw = (0.21*$price);
$total = ($btw+$price);
$user = "Mike Oerlemans";
$userAddress = "Ronsel 4";
$userZipcode = "5133CC Riel";
$userEmail = "mikeo26@gmailcom";
...
$pdf->Cell(0,5,$zipcode,0,1,'L');
$pdf->Cell(0,5,$email,0,1,'L');
$pdf->Cell(0,5,'Tel: '.$telephone,0,1,'L');
$pdf->SetFont('Times','',12);
$pdf->SetTextColor(32);
$pdf->Cell(0,5,$user,0,1,'R');
$pdf->Cell(0,5,$userAddress,0,1,'R');
$pdf->Cell(0,5,$userZipcode,0,1,'R');
$pdf->Cell(0,5,$userEmail,0,1,'R');
$pdf->Cell(0,30,'',0,1,'R');
